...
struct DayDashboardView: View {
    struct HolidayInfo: Identifiable, Equatable {
        ...
        let notes: String?       // Holiday description/explanation
    ...
    var body: some View {
        ...
        .sheet(item: $selectedHoliday) { holiday in
            SpecialDayDetailSheet(item: SpecialDayRow(from: holiday, date: date))
        }
...
#Preview {
    ...
    return DayDashboardView(
        ...
        holidays: [
            DayDashboardView.HolidayInfo(id: "1", name: "Midsummer Eve", isBankHoliday: true, symbolName: "sun.max.fill", regionCode: "SE", ruleID: "SE-midsummer", notes: "Celebrated with maypole dancing and herring."),
            DayDashboardView.HolidayInfo(id: "2", name: "元日", isBankHoliday: true, symbolName: nil, regionCode: "JP", ruleID: "JP-newyear", notes: nil)
        ],
        birthdays: [
