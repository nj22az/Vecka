...
class HolidayManager {
    ...
    private func getDefaultRulesForRegion(_ region: String) -> [HolidayRule] {
        ...
        case "FI":
            return [
                ...
                systemRule(name: "Pyhäinpäivä", isBankHoliday: true, type: .nthWeekday, month: 11, weekday: 7, ordinal: 1),
    ...
    private func seedSwedishRules(context: ModelContext) {
        ...
        let rules: [HolidayRule] = [
            ...
            systemRule(name: "Pyhäinpäivä", region: "FI", isBankHoliday: true, type: .nthWeekday, month: 11, weekday: 7, ordinal: 1),
